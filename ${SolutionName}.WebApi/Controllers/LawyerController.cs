...
using ${SolutionName}.Application.UseCases.Lawyer.Delete;
using ${SolutionName}.Application.UseCases.Lawyer.GetAll;
using ${SolutionName}.Application.UseCases.Lawyer.GetById;
