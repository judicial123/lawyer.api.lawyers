...
using lawyer.api.lawyers.application.UseCases.Example.Delete;
using lawyer.api.lawyers.application.UseCases.Example.GetAll;
using lawyer.api.lawyers.application.UseCases.Example.GetById;
